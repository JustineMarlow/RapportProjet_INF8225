...
\begin{itemize}
    \item \textit{Curiosity-driven Exploration by Self-supervised Prediction} \cite{curiosity} \footnote{Nous avons réalisé notre présentation d'article de recherche en INF8225}
...
\newpage \section{Revue : \textit{SQIL: Imitation Learning via Reinforcement Learning with Sparse Rewards} \cite{sqil}}
...
\indent Les graphiques présentés dans l'annexe 2 ne nous permettent malheureusement pas de tirer des conclusions.
